    ...
    return (
        ...
        <div className='flex justify-between justify-items-center items-center py-4'>
                   ...
                   <div className='ml-1'>
                    ...
                    <div className='hidden md:flex space-x-6  text-sm items-center ml-16 ' >
                ...
                <input className={searchOpen ? 'w-48 py-1 px-2 rounded text-gray-600 bg-slate-100 text-sm '
                    :
                    ...
                    <button className=' bg-slate-100 text-indigo-500 mx-5 px-2 py-1 rounded font-medium text-sm hover:bg-slate-200 transtion duration-300'>Log In</button>
                </div>
                 {/* Hamburger  */}
                ...
                <div className='md:hidden flex item-center mr-2'>
                    ...
                    <button className=' bg-slate-100 text-indigo-500 mb-5 mx-3 px-2 py-1 rounded font-medium text-sm hover:bg-slate-200 transtion duration-300'>Log In</button>
                    </nav>
                  </div>
                </div>
                <input className={searchOpen ? 'w-48 py-1 px-2 text-sm rounded text-gray-600 bg-slate-100 md:hidden '
                    :
                    'hidden'} type="text" name='text' placeholder='Search' />
        </nav>
