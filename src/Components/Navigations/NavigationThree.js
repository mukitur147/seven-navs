        ...
        <nav className='md:shadow-md mb-16'>
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='hidden md:flex md:w-1/4 '>
                    ...
                    <button onClick={searchToggle} className='xs:hidden '><svg className='h-4 w-4 text-gray-700 font-light ml-1 mt-1' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
